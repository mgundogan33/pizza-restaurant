                        ...
                        <div class="services-wrap d-flex">
                            ...
                            <div class="text p-4">
                                ...
                                <form action="{{ route('add_to_cart') }}" method="POST">
                                    ...
                                    <input type="submit" value="Sipariş" class="btn btn-warning">
                                </form>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12 nav-link-wrap mb-5">
                            <div class="nav ftco-animate nav-pills" id="v-pills-tab" role="tablist"
                                ...
                                <a class="nav-link" id="v-pills-3-tab" data-toggle="pill" href="#v-pills-3"
                                    role="tab" aria-controls="v-pills-3" aria-selected="false">Burgers</a>

                                <a class="nav-link" id="v-pills-4-tab" data-toggle="pill" href="#v-pills-4"
                                    role="tab" aria-controls="v-pills-4" aria-selected="false">Pasta</a>
                            </div>
                        </div>
